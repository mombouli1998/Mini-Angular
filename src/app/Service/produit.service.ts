...
export class ProduitService {
  ...
  public ListeProduits():Observable<Array<Produit>>{
      return this.http.get<Array<Produit>>("https://banque-7bq4.onrender.com/produits");
  }
  ...
  public DeleteProduit(produit:Produit){
    return this.http.delete<Produit>("https://banque-7bq4.onrender.com/produits/"+produit.id,);
  }
  //ajouter un produit
  public AjoutProdui(produit:Produit){
    return this.http.post<Produit>("https://banque-7bq4.onrender.com/produits",produit);
  }
  //recherche de produit
  public Recherche(valeur:string):Observable<Array<Produit>>{
    return this.http.get<Array<Produit>>("https://banque-7bq4.onrender.com/produits?nom="+valeur);
  }
  //retourn le produit id
  public getProduit(id:any):Observable<Produit>{
    return this.http.get<Produit>("https://banque-7bq4.onrender.com/produits/"+id);
  }
  //modifie le produit
  public Modifie(produit:Produit):Observable<Produit>{
    return this.http.put<Produit>("https://banque-7bq4.onrender.com/produits/"+produit.id,produit);
  }
  //liste des produits categorie 
  public listCategorie(valeur:string):Observable<Array<Produit>>{
    
    return this.http.get<Array<Produit>>("https://banque-7bq4.onrender.com/produits?categorie="+valeur);
  }
  ...
  public RechercheProduit(valeur:string,objet:string):Observable<Array<Produit>>{
    return this.http.get<Array<Produit>>(`https://banque-7bq4.onrender.com/produits?nom=${objet}&categorie=${valeur}`);
  }
