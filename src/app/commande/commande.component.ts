...
export class CommandeComponent {
  ...
  constructor( private active: ActivatedRoute, private PS:ProduitService, private form:FormBuilder, private route: Router, private reçu:RecuService, private panier: PanierService){}
  ngOnInit(): void {
